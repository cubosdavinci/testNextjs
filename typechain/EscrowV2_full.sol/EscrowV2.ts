...
export declare namespace EscrowV2 {
...
encodeFunctionData(functionFragment: 'platformTaxTreasury()', values?: undefined): string;
encodeFunctionData(functionFragment: 'registerEscrow', values: [EscrowV2.OrderPayloadStruct, BytesLike]): string;
encodeFunctionData(functionFragment: 'registerEscrow((bytes16,address,address,address,uint256,uint256,uint256,uint256),bytes)', values: [EscrowV2.OrderPayloadStruct, BytesLike]): string;
...
decodeFunctionResult(functionFragment: 'usedOrderIds(bytes16)', data: BytesLike): Result;
  ...
  removeAllListeners<TCEvent extends TypedContractEvent>(event?: TCEvent): Promise<this>
    ...
    registerEscrow: TypedContractMethod<
      [orderPayload: EscrowV2.OrderPayloadStruct, signature: BytesLike, ],
      [void],
      'payable'
    >
