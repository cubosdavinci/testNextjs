...
import { getDriveFileMetadata, downloadDriveFileBlob } from '@/lib/google-drive-utils';
          ...
          {files.map(file => (
            ...
            >
              ...
              <div className="flex justify-between items-start">
                ...
                {/* ❌ REMOVE BUTTON (ErrorAlert style) */}
                <button
                  onClick={() => removeFile(file.id)}
                  className="absolute top-2 right-2 text-gray-400 hover:text-red-500 text-xl leading-none transition-colors"
