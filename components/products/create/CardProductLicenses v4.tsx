  ...
  const LicenseCard = ({ index, license }: { index: number; license: CreateProductLicenseVars }) => (
    <div className="border p-4 my-4 rounded-md shadow-sm">
      ...
      <div className="space-y-4 mt-4">
        ...
        {/* Region */}
        <CardRegionSelector
          selectedRegion={license.region}  // Pass the region for this license
          regionIcons={icons}              // Pass the icons for the regions
          onRegionChange={(newRegion) => handleLicenseChange(index, "region", newRegion)}  // Update the region when changed
        />
