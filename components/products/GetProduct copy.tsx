...
export default function GetProduct({ id, clientId }: GetProductProps) {
        ...
        <div className="p-6 max-w-3xl mx-auto space-y-6">
            ...
            <Card>
                ...
                {licenses.map((lic) => (
                    ...
                    <p>
                        <strong>License:</strong> {lic.licenseName || "Unnamed"}
                    </p>
                    <p>
                        <strong>Price:</strong> ${(lic.priceCents / 100).toFixed(2)} {lic.currency}
                    </p>
                    {lic.isMain && <p className="text-green-600 font-semibold">Main License</p>}
                    </div>
                ))}
                </CardContent>
            </Card>
